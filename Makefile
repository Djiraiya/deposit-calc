...
bin/deposit-calc-test : build/test/main.o build/test/deposit-test.o build/test/validation_test.o
	gcc build/test/main.o build/test/deposit-test.o build/test/validation_test.o build/test/deposit.o -o bin/deposit-calc-test $(CFLAGS)
...
build/test/validation_test.o : test/validation_test.c
	gcc -c test/validation_test.c -o build/test/validation_test.o $(CFLAGS)
