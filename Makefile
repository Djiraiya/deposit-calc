...
bin/deposit-calc-test : build/test/main.o build/test/deposit_test.o build/test/validation_test.o
	gcc build/test/main.o build/test/deposit_test.o build/test/validation_test.o build/test/deposit.o -o bin/deposit-calc-test $(CFLAGS)
